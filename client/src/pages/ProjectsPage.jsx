...
export const ProjectsPage = () => {
  ...
  useEffect(() => {
    const fetchContent = async () => {
      try {
        const res = await pageContentAPI.getByPage('projects');
  ...
  return (
    <div className="bg-gray-50 min-h-screen pt-24 pb-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h1 className="font-['Cinzel'] text-4xl md:text-5xl font-bold text-[#00714C] mb-6">Student & Faculty Projects</h1>
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl border border-gray-100 flex flex-col items-center justify-center text-center py-20">
            ...
            <p className="text-gray-500 max-w-md">
              We are preparing comprehensive documentation regarding CAMRI's Student & Faculty Projects.
            </p>
          </div>
        )}
      </div>
